...
public class AnimacaoTela extends JFrame {
	...
	public AnimacaoTela() {
		...
		tela = new JPanel() {
			...
			public void paintComponent(Graphics g) {
				...
				g.drawLine(0, 20, 640, 240+ct);
				g.drawRect(10, 25+ct, 20, 20);
				g.drawOval(30+ct, 20, 40, 20);

				g.setColor(Color.YELLOW);
				g.drawLine(320-ct, 0, 320, 480);
	...
	public static void main(String[] args) {
		AnimacaoTela janela = new AnimacaoTela();
		janela.iniciaAnimacao();
	}
